...
const questions = [
	...
	{
		"question": "تسمى المتشكلات الناتجة عن اختالف ترتيب المجموعات واتجاهها حول الرابطة الثنائية؟",
		"answers": [
	...
	{
		"question": "اذكر الصيغة الجزيئية للمركب ايثان؟",
		"answers": [
			["C2H4", false],
			["C2H6", true],
			["C3H8", false]
	...
	{
		"question": "مجموعتا الميثيل الواقعة في نفس التجاه يشار اليها بالبادئة ترانس ؟",
		"answers": [
			["صح", false],
			["خطأ", true]
		]
